...
//
//go:generate thrift --out .. --gen go:package=$GOPACKAGE,thrift_import=github.com/bsm/parquet-go/parquetformat/internal/thrift,read_write_private parquet.thrift
